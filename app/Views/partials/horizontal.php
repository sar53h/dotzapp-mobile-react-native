        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="#"><i class="uil uil-sign-out-alt font-size-18 align-middle mr-1 text-muted"></i> <span class="align-middle"><?= lang('Files.Sign out') ?></span></a>
                </div>
            </div>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/">
                                <i class="uil-home-alt mr-2"></i> <?= lang('Files.Dashboard') ?>
                            </a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="uil-flask mr-2"></i><?= lang('Files.UI Elements') ?> <div class="arrow-down"></div>
                            </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="uil-apps mr-2"></i><?= lang('Files.Apps') ?> <div class="arrow-down"></div>
                            </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="uil-layers mr-2"></i><?= lang('Files.Components') ?> <div class="arrow-down"></div>
                            </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="uil-copy mr-2"></i><?= lang('Files.Extra Pages') ?> <div class="arrow-down"></div>
                            </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="uil-window-section mr-2"></i><?= lang('Files.Layouts') ?> <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                <a href="layouts-vertical" class="dropdown-item"><?= lang('Files.Vertical') ?></a>
                                <a href="layouts-horizontal" class="d-none dropdown-item"><?= lang('Files.Horizontal') ?></a>
                                <a href="layouts-dark-topbar" class="dropdown-item"><?= lang('Files.Dark Topbar') ?></a>
                                <a href="layouts-boxed-horizontal" class="dropdown-item"><?= lang('Files.Boxed Horizontal') ?></a>
